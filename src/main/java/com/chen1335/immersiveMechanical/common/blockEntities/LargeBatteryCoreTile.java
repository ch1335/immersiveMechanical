...
public class LargeBatteryCoreTile extends IEBaseBlockEntity implements IEBlockInterfaces.IBlockEntityDrop {
    public MutableEnergyStorage energy = new MutableEnergyStorage(128000000);
    ...
    @Override
    public void writeCustomNBT(CompoundTag compoundTag, boolean b, HolderLookup.Provider provider) {
        compoundTag.putInt("energyStorage", energy.getEnergyStored());
    }


    @Override
    public void readCustomNBT(CompoundTag compoundTag, boolean b, HolderLookup.Provider provider) {
