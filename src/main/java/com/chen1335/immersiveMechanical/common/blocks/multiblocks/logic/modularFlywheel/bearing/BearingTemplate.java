...
public class BearingTemplate extends TestAbleTemplateMultiblock {
    @Override
    public boolean isBlockTrigger(BlockState state, Direction d, @NotNull Level world) {
        return false;
    }

    public BearingTemplate(ResourceLocation loc, BlockPos masterFromOrigin, BlockPos triggerFromOrigin, BlockPos size, MultiblockRegistration<?> logic, List<BlockMatcher.MatcherPredicate> additionalPredicates, float manualScale) {
