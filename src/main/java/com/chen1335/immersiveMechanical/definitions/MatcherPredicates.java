...
public class MatcherPredicates {
    ...
    public static BlockMatcher.Result flywheelMaterial(BlockState expected, BlockState found, @Nullable Level world, @Nullable BlockPos pos) {
        if (found.getBlock() == Blocks.IRON_BLOCK || found.getBlock() == Blocks.GOLD_BLOCK) {
            return BlockMatcher.Result.allow(2);
        }
        return BlockMatcher.Result.DEFAULT;
    }
