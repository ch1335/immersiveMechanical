...
public class IMMultiblocks {
    ...
    public static final MultiblockDefinition<FlyWheelLogic.State, FlyWheelLogic> FLYWHEEL = REGISTRATE.multiblock("flywheel", FlyWheelLogic::new, FlyWheelTemplate::new)
            .notMirrored()
